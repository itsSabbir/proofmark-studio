...
> **Catalog:** 49 tools registered · **34 live** end-to-end · 7 beta · 8 planned.
...
| Live-only (default) — `display_counts: 34/0/0` | Roadmap mode — all 49 tiles |
|---|---|
...
**AI** — ai-pdf-assistant, chat-with-pdf, ai-pdf-summarizer, translate-pdf

### Beta (7) — hidden by default
