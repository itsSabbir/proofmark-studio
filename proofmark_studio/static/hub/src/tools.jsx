...
const TOOLS = [
  ...
  { slug:'compress-pdf',      title:'Compress PDF',    group:'organize',     cat:'organize', status:'planned', icon:'compress', desc:'Shrink file size without losing structure.', popular:true },
  { slug:'rotate-pdf',        title:'Rotate PDF',      group:'organize',     cat:'organize', status:'planned', icon:'rotate',   desc:'Rotate pages and normalize orientation.' },
